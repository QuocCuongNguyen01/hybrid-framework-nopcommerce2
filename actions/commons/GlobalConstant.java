...
public class GlobalConstant {
	...
	public static final String UPLOAD_PATH = RELATIVE_PROJECT_PATH+File.separator+"UploadFile"+File.separator;
	public static final String DOWNLOAD_PATH = RELATIVE_PROJECT_PATH+File.separator+"downloadFile"+File.separator;
